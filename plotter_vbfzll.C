...
//	cout<<nentries<<endl;
    ...
    bool plotOutput_NN = true;
    bool histo_Preparation_To_Fit = true;
...
//     plotOutput_NN = true;
    ...
    if (plotOutput) plotOutput_NN = true;
    if ( ((QCDScaleWeight_str.CompareTo("none")!=0)&&(QCDScaleWeight_str.CompareTo("nom")!=0)) || ((JESWeight_str.CompareTo("none")!=0)&&(JESWeight_str.CompareTo("nom")!=0)) ) histo_Preparation_To_Fit = true;
...
//    reader->AddVariable("Jet1q_pt",&TMVA.Jet1q_pt);
    ...
    //eader->AddVariable("energytot",&TMVA.energytot);
...
//    reader->BookMVA("BDTG", "/gpfs/ddn/cms/user/mandorli/CMSSW_8_0_24/src/fileSkimOutputMVA/Classification_BDTG.weights.xml");
    reader->BookMVA("BDTG","/afs/cern.ch/work/g/gimandor/private/Hmumu/restartFromFilippo/CMSSW_8_0_28/src/code/BDTxml/Classification_BDTG.weights.xml");
    }

 //"/afs/cern.ch/user/a/abonavit/private/tesi/training/CMSSW_8_0_28/src/training/TMVA-v4.2.0/test/codice_FilippoErrico
